...
import { TransactionData, BeverageShort, BeverageFromLongToShort, GenderFromLongToShort, ageIntervals } from "../../types";
// @ts-ignore
...
const AgeChartCard: React.FC<ChartCardProps> = ( { data } ) => {
    ...
    const updateDataset = (data: TransactionData[]) => {
        ...
        genders.forEach((g, gindex) => {
            ...
            filteredData.forEach((transaction) => {
                revenenues[ageIntervals[Math.floor(transaction.age/10)%ageIntervals.length]] += transaction.price || 0
            })
