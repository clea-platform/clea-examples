...
EvadtsPayloadRaw* evadtsRetriever_readDataCollection(bool init_connection, bool resetValue){
    ...
    bool connection_success     = true;
            ...
            extern uint8_t report_example_start[] asm("_binary_evoca_kalea_report_2_txt_start");
            extern uint8_t report_example_end[] asm("_binary_evoca_kalea_report_2_txt_end");
